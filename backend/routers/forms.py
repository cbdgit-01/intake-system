...
def form_row_to_dict(row) -> dict:
    ...
    return {
        ...
        "consignerCity": row["consigner_city"],
        "consignerState": row["consigner_state"],
        "consignerZip": row["consigner_zip"],
        ...
        "contractInitials": row["contract_initials"],
    ...
    if existing:
        await conn.execute(
            """UPDATE forms SET
                ...
                consigner_address = $5, consigner_city = $6, consigner_state = $7, consigner_zip = $8,
                consigner_phone = $9, consigner_email = $10,
                intake_mode = $11, status = $12, items = $13::jsonb, enabled_fields = $14::jsonb,
                signature_data = $15, initials_1 = $16, initials_2 = $17, initials_3 = $18,
                contract_initials = $19, payment_preference = $20,
                signature_date = $21, accepted_by = $22, signed_at = $23
            WHERE id = $1::uuid""",
            form_id,
            ...
            form_data.get("consignerCity"),
            form_data.get("consignerState"),
            form_data.get("consignerZip"),
            ...
            form_data.get("contractInitials"),
            form_data.get("paymentPreference"),
